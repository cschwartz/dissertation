...
Then, in \refsec{network:network_traces:numerical_results} we use the proposed methodology to evaluate the impact of various network configurations on four popular applications.
