...
Then, the ideas can be easily transferred to the more complex three states scenario in \refsec{sec:network:performance_model:system_description:three_states}.
