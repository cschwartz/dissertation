...
Then, the ideas can be easily transferred to the more complex three states scenario in \refsec{sec:network:performance_model:analytical_model:three_states}.
...
\subsubsection*{The Case of Two \headershortacr{RRC} States}\label{sec:network:performance_model:analytical_model:two_states}
...
\subsubsection*{Extension for Three \headershortacr{RRC} States}\label{sec:network:performance_model:analytical_model:three_states}
...
\subsubsection*{Modeling Signaling Intensity and Power Drain of the \headershortacr{UE}}\label{sec:network:performance_model:analytical_model:metrics}
