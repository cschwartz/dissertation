...
Then, in \refsec{sec:network:performance_model:numerical_examples} we use the model to study the impact of traffic characteristic on metrics such as signalling intensity and power drain.
