...
\begin{figure}
  \centering
  \includegraphics{cloud/virtualized_network_functions/modeling/figures/traditional_ggsn}
...
\subsubsection*{GGSN using Network Function Virtualisation}\label{sec:cloud:virtualized_network_functions:model:virtual_ggsn}
...
This allows us to realize benefits from cloud computing, as we are now able to scale out, instead of up.
