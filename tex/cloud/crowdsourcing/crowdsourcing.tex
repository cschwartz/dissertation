...
Finally, in \refsec{sec:cloud:crowdsourcing:performance_evaluation} we evaluate the provided model using the obtained parameters and discuss the trade-off between employer and worker satisfaction from the point of view of the platform operator.
