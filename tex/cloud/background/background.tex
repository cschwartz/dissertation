...
The goal of the authors in~\cite{Mazzucco2010a, Dyachuk2010, Mazzucco2010b} is to run a minimum number of servers in a data centre to maximize the revenue of the service provider.
...
The crowdsourcing approach is used for a large variety of non-profit, academic, and commercial applications, including information gathering during crisis~\cite{Morrow2011}, analysis of astronomic images~\cite{Raddick2010}, and by numerous large scale labour providers, e.g., Amazon Mechanical Turk~(MTurk)\footnote{\url{http://www.mturk.com}, Accessed: November, \(21^{st}\) 2015}, Microworkers\footnote{\url{http://www.microworkers.com}, Accessed: November, \(21^{st}\) 2015}, and Innocentive\footnote{\url{http://www.innocentive.com}, Accessed: November, \(21^{st}\) 2015}.
