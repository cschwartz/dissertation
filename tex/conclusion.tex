...
However, the interests and \glspl{KPI} of the stakeholders in today's Internet do often collide with each other and sometimes even conflict.%, resulting in complex inter-dependencies of stakeholder interests.
...
We first study the impact of a network's configuration on relevant \glspl{KPI}.
