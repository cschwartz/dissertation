...
\defbibheading{book_chapter}{\section{Book Chapters}}
\defbibheading{journal}{\section{Journal Papers}}
\defbibheading{conference}{\section{Conference Papers}}
\defbibheading{demo}{\section{Software Demonstrations}}
...
\printbibliography[title={Book Chapters},keyword=book_chapter]
\printbibliography[title={Journal},keyword=journal]
\printbibliography[title={Conference},keyword=conference]
\printbibliography[title={Software Demonstrations},keyword=demo]
