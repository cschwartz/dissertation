\chapter{Application Behaviour in Mobile Networks}\label{chap:application}
...
Deploying such applications can impact other stakeholders, e.g. \emph{Signalling Storms} interfering with the operation of mobile networks as discussed in \refsec{sec:network:network_traces}.
...
In \refsec{sec:application:cloud_file_synchronisation} we consider the impact of different file synchronisation scheduling algorithms on the relevant stakeholders.
Finally, we discuss lessons learned in \refsec{sec:application:lessons_learned}.
