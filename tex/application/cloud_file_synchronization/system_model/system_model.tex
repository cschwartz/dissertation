...
This measure also enables a more general evaluation then the actually consumed power, because the concrete power drain differs significantly for each device.
