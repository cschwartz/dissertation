...
Then, in \refsec{sec:application:background:application_qoe} we discuss related work regarding 
\gls{QoE} for video playback including \gls{QoE} modeling approaches, user profiles, and \gls{QoE} management mechanisms.
...
The authors of \cite{Luan2010} evaluate the impact of network dynamics and \gls{QoS} provision on user's video quality. 
