...
Various resource management mechanisms to improve \gls{QoE} for YouTube have been proposed in literature, e.g. in Wi-Fi mesh networks~\cite{Wamser2013} or using \gls{SDN}~\cite{Zinner2014}.
