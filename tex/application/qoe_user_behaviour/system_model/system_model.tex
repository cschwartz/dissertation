...
We obtain the following equilibrium state equations, based on the state diagram given in \reffig{fig:application:youtube_qoe_model:system_model:mm1pq:state_diagram}.
\begin{align*}
  \lambda x(0, 0) &= 0 & &\\
