...
\begin{figure}
  ...
  \caption{Influence of bitrate and selected download mechanism on energy consumption \energyconsumption.}
...
\begin{figure}
  ...
  \caption{Influence of bitrate and selected download mechanism on the connection count \connectioncount.}
