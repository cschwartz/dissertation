...
As a consequence, we only consider scenarios where no stalling occur, i.e. the delivery bandwidth is larger than the video bitrate to ensure a smooth video playout.
...
Each of the stakeholders is interested in different \glspl{KPI}, from which we derive a set of metrics to consider during the performance evaluation of the network and video playback model.
