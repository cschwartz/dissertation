...
p <- ggplot(data, aes(x = phase.start, xend = phase.end,
  ...
  geom_segment() +
  geom_point() +
  annotate("text", x = 1.7, y = 2, label = 'lambda', parse = T, size = annotation.font.size, family = annotation.font) + 
  annotate("text", x = 3.85, y = 2, label = 'mu - lambda', parse = T, size = annotation.font.size, family = annotation.font) +   
  annotate("text", x = 8.65, y = 2.5, label = 'mu - lambda', parse = T, size = annotation.font.size, family = annotation.font) + 
  annotate("text", x = 9, y = 1, label = 'mu', parse = T, size = annotation.font.size, family = annotation.font) +     
  annotate("text", x = 7, y = 3, label = '...', parse = T, size = annotation.font.size, family = annotation.font) +
  ...
  annotate("text", x = 2, y = 0.8, label = 'L', parse = T, size = annotation.font.size, family = annotation.font) +     
  annotate("text", x = 2.8, y = 2, label = 'd', parse = T, size = annotation.font.size, family = annotation.font) +
